                    ...
                    <div class="product-content-right">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    ...
                                    <c:set var="lstDetail" value="${lstDetail}"></c:set>
                                    <c:forEach items="${lstDetail}" var="detailPro" >
                                    	<img src="${detailPro.product_image}" alt="">
                                    </c:forEach>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                	...
                                	<c:set var="cateDetail" value="${cateDetail}"></c:set>
                                        	
                                	
                                	<c:set var="lstDetail" value="${lstDetail}"></c:set>
                                	<c:forEach items="${lstDetail}" var="detailPro" begin="0" end="0">
                                    <h2 class="product-name">
                                                		<c:out value="${detailPro.product_name}"></c:out>
                                                	</h2>
                                    <div class="product-inner-price">
                                        <ins>$<c:out value="${detailPro.product_price}"></c:out></ins> <del>$<c:out value="${detailPro.product_price_promotion}"></c:out></del>
                                    </div>    
                                            ...
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">
                                                ...
                                                <p>
                                                	<c:set var="lstDetail" value="${lstDetail}"></c:set>
                                                		...
                                                		<c:out value="${detailPro.description}"></c:out>
                        ...
                        <div class="related-products-wrapper">
                            ...
                            <div class="related-products-carousel">
								<c:set var="lstPro" value="${lstPro}"></c:set>
								<c:forEach items="${lstPro}" var="product">
									<div class="single-product">
										<div class="product-f-image">
											...
											<div class="product-hover">
												<a href="#" class="add-to-cart-link"><i
													...
													href="<c:url value="detailProduct">  
									        				<c:param name="namePro" value="${product.product_name}"/>
									        				<c:param name="cateID" value="${product.product_category_id}"/>
									       					</c:url>" class="view-details-link"><i
									    ...
									    "><c:out
													value="${product.product_name}"></c:out></a>
										...
										<div class="product-carousel-price">
											...
											<del>
												$
												<c:out value="${product.product_price_promotion}"></c:out>
											</del>
										</div>
									</div>
								</c:forEach>
